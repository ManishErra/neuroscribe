...
def run_verification():
    ...
    res_reg = client.post("/auth/register", json={"email": email_reg, "password": "password123", "name": "Verify Reg"})
    ...
    # Login (Public)
    res_login = client.post("/auth/login", json={"email": email_reg, "password": "password123"})
