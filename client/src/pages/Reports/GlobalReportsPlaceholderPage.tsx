...
export default function GlobalReportsPlaceholderPage() {
  ...
  return (
    <div className="max-w-md mx-auto min-h-[70vh] flex flex-col items-center justify-center p-6 text-center">
      <div className="bg-white border border-[#E2E8E4] rounded-2xl shadow-sm p-8 flex flex-col items-center">
        ...
        <h1 className="text-lg font-bold text-[#1a1c1a] mb-2">Reports Archive</h1>
        <p className="text-xs text-[#424843] leading-relaxed mb-6">
          Patient lab reports, medical histories, and OCR text extractions are managed inside specific patient workspace files.
          Please select a patient from the directory to access their reports.
        </p>
        <Button
